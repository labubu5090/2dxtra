...
namespace iidxtra::score_set
{
	...
	extern bm2dx::game_score_t* stock_p1;
	extern bm2dx::game_score_t* stock_p2;
	extern bm2dx::game_score_t* stock_rivals_p1;
	extern bm2dx::game_score_t* stock_rivals_p2;
